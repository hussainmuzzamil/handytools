...
class DomainAPI {
	...
	public function is_available($domain) {
		...
		$whois_arr = array(
			...
			// ".bo" => array("whois.nic.bo","MATCH"), // No unique "not found" message :C
			".boutique" => array("whois.donuts.co","Domain not found."),
			// ".bq" => array("none","MATCH"),
			// ".br" => array("whois.registro.br","MATCH"), // Seems like this is broken
			// ".bs" => array("none","MATCH"),
			// ".bt" => array("none","MATCH"),
			".build" => array("whois.nic.build","No Data Found"),
			".builders" => array("whois.donuts.co","Domain not found."),
			// ".buzz" => array("none","MATCH"),
			// ".bv" => array("none","MATCH"),
			...
			".dance" => array("whois.unitedtld.com","MATCH"),
